/*
 * Copyright (C) 2015 Dimitri Emmerich
 */
...
int board_init(void)
{
	...
	struct davinci_gpio *gpio23_base = (struct davinci_gpio*)DAVINCI_GPIO_BANK23;

	gd->bd->bi_arch_number = MACH_TYPE_DM368_ASC;
	gd->bd->bi_boot_params = PHYS_SDRAM_1 + 0x100;

	/* PINMUX2: Enable AEMIF pins and PGIO½64:57] */
